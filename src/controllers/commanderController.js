...
const getExcelCutRice = async (req, res) => {
  ...
  worksheet.getCell("B2").value = "HỌC VIỆN KỸ THUẬT QUÂN SỰ";
  ...
  worksheet.getCell("O5").value = "Hà Nội, ngày ... tháng ... năm 2024";
  ...
  cutRices.forEach((record, index) => {
    const row = [
      record.fullName,
      record.monday.breakfast ? 1 : 0,
      record.monday.lunch ? 1 : 0,
      record.monday.dinner ? 1 : 0,
      record.tuesday.breakfast ? 1 : 0,
      record.tuesday.lunch ? 1 : 0,
      record.tuesday.dinner ? 1 : 0,
      record.wednesday.breakfast ? 1 : 0,
      record.wednesday.lunch ? 1 : 0,
      record.wednesday.dinner ? 1 : 0,
      record.thursday.breakfast ? 1 : 0,
      record.thursday.lunch ? 1 : 0,
      record.thursday.dinner ? 1 : 0,
      record.friday.breakfast ? 1 : 0,
      record.friday.lunch ? 1 : 0,
      record.friday.dinner ? 1 : 0,
      record.saturday.breakfast ? 1 : 0,
      record.saturday.lunch ? 1 : 0,
      record.saturday.dinner ? 1 : 0,
      record.sunday.breakfast ? 1 : 0,
      record.sunday.lunch ? 1 : 0,
      record.sunday.dinner ? 1 : 0,
    ];
  ...
  const totalColumns = 22; // Số cột từ 'Họ và tên' tới 'Chủ nhật'
  ...
  worksheet.getCell(`Q${totalRows + 6}`).value = "Trần Văn Thế";
